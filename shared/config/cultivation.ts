export const realms = {
  ...
  fighter_mid: {
    level: 5, name: 'Võ Giả Cấp Trung', expRequired: 5000,
  ...
  fighter_high: {
    level: 6, name: 'Võ Giả Cấp Cao', expRequired: 12000,
  ...
  // Chiến Tướng
  warlord_low: {
    level: 7, name: 'Chiến Tướng Cấp Thấp', expRequired: 30000,
